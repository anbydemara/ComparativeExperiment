...
DATASETS_CONFIG = {
    ...
    'HHK20': {
        ...
        'gt': 'ZY_HHK_gt108_20200628.mat',
    },
    'HHK21': {
        'img': 'ZY_HHK_data108_20210929.mat',
        'gt': 'ZY_HHK_gt108_20210929.mat',
    },
    'YC119': {
...
def get_dataset(dataset_name, target_folder="./", datasets=DATASETS_CONFIG):
    ...
    if dataset_name == 'Houston13':
        ...
        label_values = ["tree", "asphalt", "brick",
                        "bitumen", "shadow", 'meadow']

        ignored_labels = [0]

    elif dataset_name == 'HHK119':
        # Load the image
